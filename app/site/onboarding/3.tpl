...
<div class="box" style="margin-top: 0">
    ...
    <form id="form" action="" method="POST" accept-charset="utf-8">
        ...
        <label for="pfp">Profile pics (up to 15)<span class="required" aria-label="Required" role="tooltip" data-microtip-position="top">*</span></label>
        <p class="help_text" style="margin-top: 4px">Upload your VR avatar pictures!</p>
        <input id="pfp"
               type="hidden"
