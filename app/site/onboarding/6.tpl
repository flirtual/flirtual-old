...
<div class="box">
    ...
    <form action="" method="POST" accept-charset="utf-8">
        ...
        <select name="age">
            ...
            <option value="rovr" %(`{if {~ $age rovr} { echo 'selected' }}%)>Anyone on ROVR</option>
        ...
        <select name="gender">
            ...
            <option value="rovr" %(`{if {~ $gender rovr} { echo 'selected' }}%)>Anyone on ROVR</option>
        ...
        <select name="country">
            ...
            <option value="rovr" %(`{if {~ $country rovr} { echo 'selected' }}%)>Anyone on ROVR</option>
        ...
        <select name="interests_common">
            <option value="rovr" %(`{if {~ $interests_common rovr} { echo 'selected' }}%)>Anyone on ROVR</option>
        ...
        <select name="interests_uncommon">
            ...
            <option value="rovr" %(`{if {~ $interests_uncommon rovr} { echo 'selected' }}%)>Anyone on ROVR</option>
        ...
        <select name="bio">
            ...
            <option value="rovr" %(`{if {~ $bio rovr} { echo 'selected' }}%)>Anyone on ROVR</option>
        ...
        <select name="language">
            ...
            <option value="rovr" %(`{if {~ $language rovr} { echo 'selected' }}%)>Anyone on ROVR</option>
        ...
        <select name="platform">
            ...
            <option value="rovr" %(`{if {~ $platform rovr} { echo 'selected' }}%)>Anyone on ROVR</option>
        ...
        <select name="games">
            ...
            <option value="rovr" %(`{if {~ $games rovr} { echo 'selected' }}%)>Anyone on ROVR</option>
        ...
        <select name="socials">
            ...
            <option value="rovr" %(`{if {~ $socials rovr} { echo 'selected' }}%)>Anyone on ROVR</option>
        ...
        <select name="friends">
            <option value="rovr" %(`{if {~ $friends rovr} { echo 'selected' }}%)>Anyone on ROVR</option>
